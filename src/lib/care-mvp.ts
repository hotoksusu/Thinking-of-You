...
export type FollowUp = { id:string; episodeId?:string; patientId:string; hospitalId:string; triggeredFromCheckInId?:string; action:string; actionType?:ActionType; outcomeCategory?:OutcomeCategory; staffDecision?:StaffDecision; note:string; status:"completed"; handledBy:string; performedByRole?:string; performedAt?:string; source?:"hospital_staff"; createdAt:string; completedAt:string };
