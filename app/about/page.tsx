  ...
  return (
    <main className="min-h-screen bg-[#FFF9F0] pb-28 text-[#20302C]">
      ...
      <section className="mx-auto w-full max-w-[980px] px-5 py-16 sm:px-8 sm:py-24">
        <p className="inline-flex rounded-full bg-[#EAF3E5] px-4 py-2 text-sm font-black text-[#2F6B46]">{PRODUCT_COPY.radarName}</p>
        <h1 className="mt-5 text-4xl font-black leading-tight sm:text-6xl">매일 상태를 묻지 않고,<br />평소와 다른 흐름을 확인합니다.</h1>
        <div className="readable-sentences mt-6 max-w-[760px] text-lg font-bold leading-8 text-[#5E6C66] sm:text-xl"><p>{PRODUCT_COPY.parentBehavior}</p><p>반복되는 변화를 살펴봅니다.</p><p>가족에게 행동 하나를 알려드립니다.</p></div>
        ...
        <section className="mt-16 rounded-[24px] bg-[#203C2B] p-7 text-white sm:p-10">
          ...
          <p className="mt-5 font-black text-[#B9E1C0]">{PRODUCT_COPY.engineName}</p>
          <h2 className="mt-3 text-3xl font-black">부모님 본인의 평소와 비교합니다.</h2>
