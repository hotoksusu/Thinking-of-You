  ...
  return (
    <main className="min-h-screen bg-[#FFF9F0] pb-28 text-[#20302C]">
      ...
      <section className="mx-auto w-full max-w-[1080px] px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-[700px] text-lg font-bold leading-8 text-[#5E6C66]">현재는 체험용 데이터로 모든 흐름을 확인할 수 있습니다. 실제 결제는 연결되어 있지 않으며, 정식 출시 전에 요금을 안내합니다.</p>
      ...
      <section className="mx-auto mb-16 w-[calc(100%-2.5rem)] max-w-[1030px] rounded-[26px] bg-[#EAF3E5] p-6 text-center sm:p-8"><h2 className="text-2xl font-black">매일 확인하지 않아도,<br className="sm:hidden" /> 달라진 날을 알려드립니다.</h2><p className="mt-3 font-bold text-[#5E6C66]">안심 구독의 핵심 가치는 더 많은 정보가 아니라 필요한 날의 알림입니다.</p></section>
      <MobileStartCta />
    </main>
  );
}
