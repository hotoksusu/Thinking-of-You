    ...
    <main className="onboarding-page bg-[#F7F9F6] px-5 text-[#17251F]">
      ...
      <section className="mx-auto flex min-h-0 w-full max-w-[560px] flex-1 flex-col pt-4">
        ...
        <div className="shrink-0 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          ...
          <button type="button" onClick={step < 3 ? () => setStep(step + 1) : finish} className="flex min-h-[72px] w-full items-center justify-center gap-2 rounded-[22px] bg-[#2F6B46] px-6 text-[1.3rem] font-black text-white shadow-[0_12px_28px_rgba(47,107,70,0.22)]">{step < 3 ? "알겠습니다" : "가족 화면 시작"}<ArrowRight size={24} /></button>
